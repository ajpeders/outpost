#!/bin/bash
# Living-room MTV page: cage (software/pixman compositor) running chromium in kiosk
# mode on MTV_URL over the Pi's HDMI. The screen player stops this service before
# playing mpv (both need DRM master) and starts it again when playback ends.
set -e
...
URL="${MTV_URL:-https://mtv.thelunadog.com}"
